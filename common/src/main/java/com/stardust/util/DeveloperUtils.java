...
public class DeveloperUtils {
    ...
    private static final String PACKAGE_NAME = "com.hamibot.hamibot";
    private static final String SIGNATURE = "/kpwh9xHfP/ImQEWPRJrme+rQrVC4LeOSdyMH7lIpaw=";
    private static final String LOG_TAG = "[h4m1]DeveloperUtils";
    ...
    public static boolean isSelfPackage(@Nullable String runningPackage) {
        //Log.d(LOG_TAG, "runningPackage:::" + runningPackage);
    ...
    public static boolean checkSignature(Context context, String packageName) {
        ...
        Log.d(LOG_TAG, "SIGNATURE.equals(sha):::" + SIGNATURE.equals(sha));
    ...
    public static boolean checkDexFile(Context context, long[] crc) {
        ...
        try {
            ...
            for (int i = 0; i < crc.length; i++) {
                ...
                Log.d(LOG_TAG, "checkDexFile:::" + String.valueOf(dexEntryCrc));
    ...
    public static void verifyApk(Activity activity, final int crcRes) {
        ...
        sExecutor.execute(new Runnable() {
            ...
            public void run() {
                ...
                Log.d(LOG_TAG, "verifyApk...crc:::" + crc);
